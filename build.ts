...
console.log(
  `${colors.bold(colors.green("Building"))} resvg web assembly...`,
);
...
const wasmBindGenCmd = [
  "wasm-bindgen",
  "./target/wasm32-unknown-unknown/release/resvg_wasm.wasm",
  "--target",
  "deno",
  "--weak-refs",
  "--out-dir",
...
const resvgWasmDest = "./lib/resvg_wasm_bg.wasm";
await Deno.copyFile(
  "./target/wasm32-bindgen-deno-js/resvg_wasm_bg.wasm",
  resvgWasmDest,
);
console.log(`  copy ${colors.yellow(resvgWasmDest)}`);
...
const generatedJs = await Deno.readTextFile(
  "./target/wasm32-bindgen-deno-js/resvg_wasm.js",
);
...
`;
const libResvgJs = "./lib/resvg.generated.js";
console.log(`  write ${colors.yellow(libResvgJs)}`);
await Deno.writeTextFile(libResvgJs, bindingJs);

const denoFmtCmd = [
  "deno",
  "fmt",
  "--quiet",
  "./lib/resvg.generated.js",
];
...
console.log(
  `${colors.bold(colors.green("Finished"))} resvg web assembly.`,
);
